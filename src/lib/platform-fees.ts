...
//
// ⚠️ AINDA NÃO LIGADO. Este arquivo sobreviveu ao merge de 14/08/2026 como a
// única peça da calculadora paralela que o `src/lib/pricing.ts` não cobre:
// lá, `ProductCosts.platformFee` é um número fixo em centavos que o seller
// digita. O encaixe é alimentar aquele campo com `platformFee(preço, schedule)`
// daqui — aí o seller para de precisar adivinhar a própria taxa.
// ---------------------------------------------------------------------------
